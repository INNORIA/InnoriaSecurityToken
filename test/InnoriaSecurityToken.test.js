...
const InnoriaSecurityToken = artifacts.require("InnoriaSecurityToken");
...
contract("InnoriaSecurityToken with token extension", function ([
  deployer,
  owner,
  operator,
  controller,
  ...
  beforeEach(async function () {
    this.token = await InnoriaSecurityToken.new(
      "InnoriaSecurityTokenTest",
      "ISTTest",
      1,
      [controller],
      partitions,
    ...
    describe("case where certificate is not defined at creation [for coverage]", function () {
      describe("can not call function if not certificate signer", function () {
        it("creates the token", async function () {
          await InnoriaSecurityToken.new(
            "InnoriaSecurityTokenTest",
            "ISTTest",
            1,
            [controller],
  ...
  describe("canTransferByPartition/canOperatorTransferByPartition", function () {
    ...
    beforeEach(async function () {
      this.token2 = await InnoriaSecurityToken.new(
        "InnoriaSecurityTokenTest",
        "ISTTest",
        localGranularity,
        [controller],
